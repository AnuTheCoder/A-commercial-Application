class AssetsManager{
  ...
  //static String animationsPath = "assets/animation/";

  //general images
  static String forgotPassword = "$imagePath/forgot_password.jpg";
  ...
  static String order = "$bagImagesPath/order.png";
  ...
  static String bookImg = "$categoriesImagesPath/book_img.png";
  ...
  static String orderimg = "$dashboardImagesPath/order.png";
