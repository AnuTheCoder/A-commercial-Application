...
class AppColors{
  static Color? lightScaffoldColor = Colors.deepPurple[100];
  // static Color lightScaffoldColor = Colors.deepPurple.shade100; To use .shade
  // static const Color lightScaffoldColor = Colors.deepPurple;
