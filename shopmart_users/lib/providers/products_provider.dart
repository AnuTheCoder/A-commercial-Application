...
class ProductsProvider with ChangeNotifier{
  ...
  //If categoryNamw is present in element.productCategory will be added to categoryList
  ...
  //If searchText is present in element.productTitle will be added to searchList
